...
DEFAULT_FRAGEN = [
    # === VIRAL WOULD YOU RATHER (TikTok / Discord Viral) ===
    {"frage": "1 pferdegroße Ente oder 100 entengroße Pferde — welche bekämpfst du?", "emoji": "🦆", "optionen": ["1 riesige Ente", "100 mini Pferde"]},
    {"frage": "Ohne Ellbogen oder ohne Knie geboren?", "emoji": "🦴", "optionen": ["Keine Ellbogen", "Keine Knie"]},
    {"frage": "Teleportieren aber nur beim Schreien oder Fliegen aber nur beim Wurmtanzen?", "emoji": "🪱", "optionen": ["Teleport (schreiend)", "Fliegen (Wurmtanz)"]},
    {"frage": "Ranch-Dressing schwitzen oder geriebenen Mozzarella niesen?", "emoji": "🧀", "optionen": ["Ranch schwitzen", "Mozzarella niesen"]},
    {"frage": "Konfetti schluchzen wenn du lügst oder Glitzer niesen wenn du die Wahrheit sagst?", "emoji": "✨", "optionen": ["Konfetti (Lüge)", "Glitzer (Wahrheit)"]},
    {"frage": "Spaghetti als Haare oder Ahornsirup als Schweiß?", "emoji": "🍝", "optionen": ["Spaghetti-Haare", "Ahornsirup-Schweiß"]},
    {"frage": "Für den Rest deines Lebens nur flüstern oder nur schreien?", "emoji": "🔊", "optionen": ["Nur flüstern", "Nur schreien"]},
    {"frage": "Alles was du sagst als Untertitel in der Luft oder private Gedanken von Morgan Freeman erzählen lassen?", "emoji": "🎬", "optionen": ["Untertitel", "Morgan Freeman Voice"]},
    {"frage": "4 Stunden mit deinem Ex im Aufzug oder 4 Stunden mit deinem Chef?", "emoji": "🛗", "optionen": ["Mit Ex", "Mit Chef"]},
    {"frage": "Einen Zeh in Fußgröße oder einen Finger in Handgröße?", "emoji": "🦶", "optionen": ["Riesenzeh", "Riesenfinger"]},
    {"frage": "Kopf in Wassermelonengröße oder Kopf in Golfballgröße?", "emoji": "🍉", "optionen": ["Wassermelonen-Kopf", "Golfball-Kopf"]},
    {"frage": "Träume steuern ohne Bearbeiten oder einen Fernseher der nur peinlichste Erinnerungen abspielt?", "emoji": "📺", "optionen": ["Träume steuern", "Peinlichster Fernseher"]},
    {"frage": "Einen winzigen Drachen überallhin mitnehmen oder ein Pferd das gegen Gras allergisch ist?", "emoji": "🐉", "optionen": ["Mini-Drache", "Allergisches Pferd"]},
    {"frage": "Mit einer Tierart fließend reden können oder 5 Menschensprachen fließend sprechen?", "emoji": "🗣️", "optionen": ["Tiere verstehen", "5 Sprachen"]},
    {"frage": "Innen immer durchnässte Socken oder draußen immer einen kleinen Kiesel im Schuh?", "emoji": "🧦", "optionen": ["Nasse Socken", "Kieselstein"]},
    {"frage": "Hand mit funktionierendem Schweizer Taschenmesser oder Fuß mit Skateboard das du nie abnehmen kannst?", "emoji": "🔪", "optionen": ["Schweizer Taschenmesser-Hand", "Skateboard-Fuß"]},

    # === HOT TAKES (Viral Debatten) ===
    {"frage": "Ist Müsli eine Suppe? Verteidige deine Antwort.", "emoji": "🥣", "optionen": ["Ja", "Nein", "Kommt drauf an"]},
    {"frage": "Ist ein Hot Dog ein Sandwich?", "emoji": "🌭", "optionen": ["Ja", "Nein", "Ist ein Taco"]},
    {"frage": "Ist Wasser nass?", "emoji": "💧", "optionen": ["Ja", "Nein", "Was zur Hölle"]},
    {"frage": "Ananas auf Pizza: akzeptabel, Kriegsverbrechen oder Kunstform?", "emoji": "🍍", "optionen": ["Akzeptabel", "Kriegsverbrechen", "Kunstform"]},
    {"frage": "Klopapierrolle: oben oder unten?", "emoji": "🧻", "optionen": ["Oben", "Unten", "Ist egal"]},
    {"frage": "Milch in die Schüssel VOR das Müsli: Ordnungswidrigkeit oder Verbrechen?", "emoji": "🥛", "optionen": ["Vorher (richtig)", "Nachher (richtig)", "Verbrechen"]},
    {"frage": "Ist ein Pop-Tart eine Ravioli?", "emoji": "🥟", "optionen": ["Ja", "Nein", "Jetzt ja"]},
    {"frage": "Sollte Klatschen nach der Landung im Flugzeug verboten werden?", "emoji": "✈️", "optionen": ["Ja verbieten", "Nein weitermachen", "Nur bei Notlandung"]},
    {"frage": "Ist ein Sandwich diagonal geschnitten besser?", "emoji": "🥪", "optionen": ["Ja diagonal", "Nein gerade", "Ist egal"]},
    {"frage": "Ist es ein Verbrechen oder ein Flex seinen eigenen Post zu liken?", "emoji": "👍", "optionen": ["Verbrechen", "Flex", "Manchmal"]},
    {"frage": "Frühstück zum Abendessen: ja oder nein?", "emoji": "🍳", "optionen": ["Ja bitte", "Nein danke", "Täglich"]},
    {"frage": "Ist es eklig die Milch am Boden der Müslischüssel zu trinken?", "emoji": "🥛", "optionen": ["Ja eklig", "Nein bester Teil", "Nur mit Schoko-Müsli"]},
    {"frage": "Sollten Erwachsene Rucksäcke auf beiden Schultern tragen dürfen?", "emoji": "🎒", "optionen": ["Ja warum nicht", "Nein eine Schulter", "Nur im Urlaub"]},

    # === ABSURDE HYPOTHESEN (Lacher garantiert) ===
    {"frage": "Wenn du für einen Anruf die Stimme eines Promis tauschen könntest, wessen?", "emoji": "🎤", "optionen": ["Morgan Freeman", "Spongebob", "Arnold Schwarzenegger", "DJ Khaled"]},
    {"frage": "Was ist die schlechteste Superkraft die dir einfällt?", "emoji": "🦸", "optionen": ["Immer nasse Socken", "Nur bei Regen fliegen", "Unsichtbar aber nur 3 Sek", "Müde werden"]},
    {"frage": "Wenn du ein Jahr lang jeden Tag dasselbe Halloween-Kostüm tragen müsstest, was?", "emoji": "🎃", "optionen": ["Darth Vader", "Pilz", "Banane", "Geist aus dem Bettlaken"]},
    {"frage": "Was ist der dümmste Grund warum du als Erwachsener geweint hast?", "emoji": "😭", "optionen": ["Essen ist ausgegangen", "Batterie leer", "Falsche Serie geschaut", "Kopfhörer verheddert"]},
    {"frage": "Wenn du einem Baby einen falschen Fakt beibringen müsstest, welcher?", "emoji": "👶", "optionen": ["Hunde können fliegen", "Die Sonne ist kalt", "Bananen sind grün", "Der Mond ist aus Käse"]},
    {"frage": "Welches normale Substantiv sollte ich gerade nicht laut aussprechen?", "emoji": "🤫", "optionen": ["Feuchtigkeit", "Schlupflider", "Würmchen", "Gliedmaßen"]},
    {"frage": "Wenn dein Leben eine Reality-TV-Show wäre, was wäre der Titel?", "emoji": "📺", "optionen": ["Kein Plan was ich tu", "Chaotic Neutral", "Nächstes Level Cringe", "Mein Leben ist ein Witz"]},
    {"frage": "Wenn du für einen Tag das Gehirn einer Pixar-Figur tauschen müsstest, welche?", "emoji": "🧠", "optionen": ["Buzz Lightyear", "Nemo", "Ratatouille-Ratte", "Die Glühwürmchen"]},
    {"frage": "Was wäre der lustigste WLAN-Name den du einrichten würdest?", "emoji": "📶", "optionen": ["FBI Surveillance Van", "5G Impfchip Hotspot", "Virus.exe", "Dein Nachbar"]},

    # === OHNE ERKLÄRUNG VERHAFTET ===
    {"frage": "Was würden deine Freunde annehmen wenn du ohne Erklärung verhaftet wirst?", "emoji": "🚔", "optionen": ["Steuerhinterziehung", "Memes gestohlen", "Döner-Krieg", "Was Cooles"]},
    {"frage": "Wenn du mit deinen Freunden einen Coup landen müsstest, was klauen wir?", "emoji": "🏦", "optionen": ["McDonalds Fritten-Rezept", "Die Moon-Flags", "Döner-Geheimrezept", "Nichts wir sind zu dumm"]},
    {"frage": "Wenn du ein Land umbenennen könntest, welches und wie?", "emoji": "🌍", "optionen": ["Deutschland → Bratwurstien", "Frankreich → Käsetopia", "Australien → Spinnenville", "Japan → Anime-Land"]},
    {"frage": "Was war das schrägste Internet-Kaninchenloch in dem du gefallen bist?", "emoji": "🐇", "optionen": ["Wikipedia 3h", "TikTok 5h", "Reddit deep dive", "YouTube loop"]},
    {"frage": "Was war das Lächerlichste das du je um 2 Uhr nachts online gekauft hast?", "emoji": "🛒", "optionen": ["Sachen die ich nicht brauche", "Nichts ich bin gescheitert", "Käse", "Einen Döner"]},
    {"frage": "Wenn du morgen für etwas Dummes berühmt aufwachst, was war das?", "emoji": "📰", "optionen": ["Vor Kamera gestolpert", "Vergessen wo ich bin", "Hab mich selbst geröstet", "Nix ich bleib ruhig"]},
    {"frage": "Wenn du morgen einen Kult starten müsstest, was wäre der Dresscode?", "emoji": "🫡", "optionen": ["Nur Bademantel", "Nur Dino-Pyjama", "Formal aber mit Flip-Flops", "Müllsack-Couture"]},
    {"frage": "Welchen schrägen Job würdest du eine Woche lang machen für doppeltes Gehalt?", "emoji": "💼", "optionen": ["Profi-Schlafer", "Käse-Tester", "Bär im Freizeitpark", "Geschmacks-Tester für Hustensaft"]},

    # === SCHNELLFEUER (Anti-Langeweile) ===
    {"frage": "Was ist dein nutzlosestes Talent?", "emoji": "🎭", "optionen": ["Können mit Ohren wackeln", "Mit Zunge Klicks machen", "Nase pfeifen", "Nichts"]},
    {"frage": "Was ist das Dümmste wofür du je mehr als 50€ ausgegeben hast?", "emoji": "💸", "optionen": ["Gaming-Skins", "Käse", "Einen Döner um 3 Uhr", "Nix"]},
    {"frage": "Was ist eine Kleinigkeit die dich irrational wütend macht?", "emoji": "😤", "optionen": ["Lautes Kauen", "Taschentuch-Krümel", "Ungeöffnete Türen", "Leere Chips-Tüte"]},
    {"frage": "Was ist gerade das zufälligste Ding in deinem Kühlschrank?", "emoji": "🧊", "optionen": ["Etwas Vergessenes", "Nix Seltsames", "Käse", "Dinge die ich nicht kenne"]},
    {"frage": "Welchen Song würdest du in Schleife abspielen um meinen Tag zu ruinieren?", "emoji": "🎵", "optionen": ["Baby Shark", "Rickroll", "Das Radlied", "Was Anderes"]},
    {"frage": "Welches normale Essen isst du auf eine Art die alle anderen anekelt?", "emoji": "🍕", "optionen": ["Fork & Knife Pizza", "Ketchup auf alles", "Essen mit Milch", "Nichts Seltsames"]},
    {"frage": "Was war der dümmste Weg dich je zu verletzen?", "emoji": "🤕", "optionen": ["Gegens Sofa gelaufen", "Handy ins Gesicht gefallen", "Kühlschrank-Tür", "Dinge die ich nicht sage"]},
    {"frage": "Was war das schrägste Traumlichtworan du dich erinnerst?", "emoji": "🌙", "optionen": ["Fliegende Pizzen", "Redende Tiere", "Eigentlich nichts", "Nichts was ich erzähle"]},

    # === GRUPPE (Wer am ehesten) ===
    {"frage": "Wer von euch würde am ehesten auf eine Nigerianischer-Prinz-E-Mail reinfallen?", "emoji": "📧", "optionen": ["Ich auf jeden Fall", "Jemand anders", "Niemand", "Alle zusammen"]},
    {"frage": "Wenn unsere Gruppe ein Maskottchen hätte, was wäre es?", "emoji": "🧸", "optionen": ["Chicken Nugget", "Gelber Smiley", "Döner", "Chaos-Bär"]},
    {"frage": "Wenn unsere Gruppe einen True-Crime-Podcast über uns selbst startet, worum geht Folge 1?", "emoji": "🎙️", "optionen": ["Der große Döner-Raub", "Wer hat die Pizza gegessen?", "Der Discord-Crash von 2024", "Nichts wir sind zu langweilig"]},
    {"frage": "Wer in der Gruppe würde am ehesten ein MLM starten?", "emoji": "💰", "optionen": ["Jemand hier", "Niemand wir sind schlau", "Ich schon", "Jemand der es nicht hören will"]},
    {"frage": "Wenn wir zusammen eine Zombie-Apokalypse überleben müssten, welche Rolle spielt jeder?", "emoji": "🧟", "optionen": ["Anführer", "Köchin", "Kanonenfutter", "Derjenige der zuerst stirbt"]},
    {"frage": "Wenn unsere Gruppe eine Cornflakes-Marke wäre, wer ist das Maskottchen?", "emoji": "🥣", "optionen": ["Jemand mit Bärten", "Ein Huhn", "Jemand der immer schläft", "Jemand der immer lacht"]},
    {"frage": "Wenn unsere Gruppe ein Tier im Zoo wäre, welches?", "emoji": "🦁", "optionen": ["Löwe", "Pfau", "Faultier", "Pinguin"]},
    {"frage": "Wenn unsere Gruppe versehentlich eine Religion gründet, was ist das erste Gebot?", "emoji": "📿", "optionen": ["Keine Kriege um Döner", "Jeden Tag memes senden", "Kein Montag", "Nur Döner am Freitag"]},

    # === DEEP THOUGHTS (aber lustig) ===
    {"frage": "Würdest du eher dein Suchverlauf auf deiner Beerdigung projiziert haben oder jede Nachricht als Hochzeitsvideo abgespielt sehen?", "emoji": "📹", "optionen": ["Suchverlauf auf Beerdigung", "Nachrichten als Hochzeitsvideo"]},
    {"frage": "Wenn du mit deinen Freunden in dieser Gruppe ein Land umbenennen könntest, welches?", "emoji": "🗺️", "optionen": ["Deutschland → Dönerreich", "Japan → Anime-Land", "USA → McDonaldia", "Australien → Spinnenville"]},
    {"frage": "Welcher Haushaltsgegenand wäre deine Waffe in einer Zombie-Apokalypse?", "emoji": "🧹", "optionen": ["Küchenmesser", "Keulentragen", "Bügeleisen", "Staubsauger"]},
    {"frage": "Wenn du eine Disney-Prinzessin sein müsstest basierend auf deinem schlechtesten Charakterzug, welche?", "emoji": "👸", "optionen": ["Die faule", "Die hungrige", "Die chaotische", "Die die immer schläft"]},
    {"frage": "Was ist der nutzloseste Fakt den du auswendig kennst?", "emoji": "🧠", "optionen": ["Tiere Fakten", "Geschichte", "Maths", "Nix nützliches"]},
    {"frage": "Wenn du eine Uni-Vorlesung über etwas komplett Nutzloses halten müsstest, was ist der Lehrplan?", "emoji": "🎓", "optionen": ["Die Geschichte des Nudelsalats", "Wie man perfekt starrt", "Die Physik des Aufschiebens", "Schnurrbart-Malerei"]},
    {"frage": "Wenn du für einen Tag nur mit einem Emoji kommunizieren dürftest, welches?", "emoji": "😀", "optionen": ["💀", "🤡", "🔥", "🗿"]},
    {"frage": "Welches Essen wäre am besten geeignet um ein Haus daraus zu bauen?", "emoji": "🏠", "optionen": ["Keks (Haus aus Lebkuchen)", "Kartoffelchips", "Waffeln", "Nutella"]},
    {"frage": "Was ist das Schrägste an dir das du einem Fremden zuerst beschreiben würdest?", "emoji": "🫠", "optionen": ["Meine Essgewohnheiten", "Mein Schlafverhalten", "Mein Internet-Verlauf", "Nichts ich bin normal"]},
]
